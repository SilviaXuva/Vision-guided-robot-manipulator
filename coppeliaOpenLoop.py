...
from Data.openLoop import red, green, blue

robotDh = DH_LBR_iiwa()
coppelia = CoppeliaSim(robotDh, drawing=True, gripper=True, camera=False, createCuboids=False)
