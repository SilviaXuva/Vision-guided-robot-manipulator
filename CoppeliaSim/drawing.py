...
class DrawingObject():
    def __init__(self, sim, tip_handle: str, color: list) -> None:
        self.sim = sim
...
class Ref(DrawingObject):
    def __init__(self, sim, tip_handle: str, color: list = blue) -> None:
        super().__init__(sim, tip_handle, color)

class Real(DrawingObject):
    def __init__(self, sim, tip_handle: str, color: list = red) -> None:
        super().__init__(sim, tip_handle, color)
...
class Drawing:
    ...
    def show(self, ref_pos: np.ndarray = None):
